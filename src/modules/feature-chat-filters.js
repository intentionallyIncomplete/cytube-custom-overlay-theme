...
const customFilters = [
  ...
  { name: "imgur direct", source: "(https?://i\\.imgur\\.com/[a-zA-Z0-9]+\\.(?:gif|webp|png|jpe?g|mp4)(?:\\?[^\\s<]*)?)", flags: "gi", replace: `<img class="imgur chat-picture chat-media"${CHAT_IMGUR_REFERRER_ATTR} src="\\1" />`, active: true, filterlinks: true },
