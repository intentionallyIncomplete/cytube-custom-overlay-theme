...
const customFilters = [
  ...
  { name: "klipy cdn", source: "(https?://static\\d*\\.klipy\\.com/[^\\s<]+)", flags: "gi", replace: "<span class=\"btfw-klipy-wrap\"><img class=\"klipy chat-picture\" src=\"\\1\" /></span>", active: true, filterlinks: true },
  { name: "tenor", source: "https?://c\\.tenor\\.com/([\\w-]+)/([^ /\\n]+\\.gif)", flags: "gi", replace: "<img class=\"tenor chat-picture\" src=\"https://c.tenor.com/\\1/\\2\" />", active: true, filterlinks: true },
  { name: "tenor media", source: "https?://media\\.tenor\\.com/([\\w-]+)/([^ /\\n]+\\.gif)", flags: "gi", replace: "<img class=\"tenor chat-picture\" src=\"https://media.tenor.com/\\1/\\2\" />", active: true, filterlinks: true },
